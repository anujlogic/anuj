                ...
                <div class="col s12 m4 card">
                    ...
                    <form class="sidebar-search" action="{{ route('search')}}" method="GET">
						...
						{{--<div class="input-field col s12">
							...
							<div class="input-field col s12">
                                <select name="radius" class="browser-default">
                                    <option value="" >Choose Radius</option>
                                   @for($i=1;$i<=25;$i++)
									   @php if($radius == $i) $sel = 'selected';else $sel = '';  @endphp
										<option value="{{$i}}" {{$sel}} >{{$i}} KM</option>	
								   @endfor		
                                </select>
                            </div>
						...
						<input type="hidden" name="loc_id" id="loc_id" value="{{request('loc_id')}}">
						<input type="hidden" name="loc" id="loc" value="{{request('loc')}}">
                    </form>
                            ...
                            <div>
                                <div class="card-content property-content">
                                    ...
                                    <h5>
									 ...
									 <h6>{{ round($property->distance,2) }} KM</h6>
