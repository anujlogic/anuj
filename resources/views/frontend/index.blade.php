                    ...
                    <div class="col s12 m4">
                        <div class="card">
                            <div class="card-image">
                                @if(file_exists('public/property/'.$property->image) && $property->image)
									<a href="{{ route('property.show',$property->slug) }}">	
										<span class="card-image-bg" style="background-image:url({{URL::asset('public/property/'.$property->image)}});"></span>
									</a>
                                @else
                            ...
                            <div class="card-content property-content">
                                ...
                                <h5>
                                    &#8377;{{ numbersToWords(round($property->price)) }}
                    ...
                    <div class="carousel-item testimonial-item" href="#{{$testimonial->id}}!">
                        <div class="card testimonial-card">
                            ...
                            <div class="card-image testimonial-image">
                                <img src="{{URL::asset('public/testimonial/'.$testimonial->image)}}">
                            </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col s12 m4">
                    <div class="card">
                        <div class="card-image">
                            @if(file_exists('public/posts/'.$post->image) && $post->image)
                                <span class="card-image-bg" style="background-image:url({{URL::asset('public/posts/'.$post->image)}});"></span>
                            @endif
                        </div>
                        <div class="card-content">
