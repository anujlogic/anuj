<footer class="page-footer indigo darken-2">
            ...
            <div class="col m6 s12">
                ...
                <ul class="collection border0">
                    ...
                    <li class="collection-item transparent clearfix p-0 border0">
                        <span class="card-image-bg m-r-10" style="background-image:url({{URL::asset('public/property/'.$property->image)}});width:60px;height:45px;float:left;"></span>
    ...
    <div class="footer-copyright">
        <div class="container">
            ...
            @else
                &copy; {{ now()->year }} Ghardekh Powered By Knotsync Pvt. Ltd. All rights reserved.
            @endif
