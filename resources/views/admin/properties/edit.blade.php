...
@push('styles')
    ...
    <link rel="stylesheet" href="{{asset('public/backend/plugins/bootstrap-select/css/bootstrap-select.css')}}">
					...
					<div class="form-group form-float">
                        <div class="form-line">
                            ...
                            <select name="seller_type" class="form-control show-tick">
                                ...
                                <option value="owner" @if(old('seller_type') == 'owner') selected @elseif(empty(old('seller_type')) && $property->seller_type == 'owner') selected @endif >Owner</option>
                                <option value="dealer" @if(old('seller_type') == 'dealer') selected @elseif(empty(old('seller_type')) && $property->seller_type == 'dealer') selected @endif>Dealer</option>
								<option value="builder" @if(old('seller_type') == 'builder') selected @elseif(empty(old('seller_type')) && $property->seller_type == 'builder') selected @endif>Builder</option>
                            </select>
                        </div>
                    </div>
					...
					<div class="form-group form-float">
                        <div class="form-line ">
                            ...
                            <select name="purpose" class="form-control show-tick">
                                <option value="">-- Please select --</option>
                                <option value="sale" @if(old('purpose') == 'sale') selected @elseif(empty(old('purpose')) && $property->purpose == 'sale') selected @endif>Sale</option>
                                <option value="rent" @if(old('purpose') == 'rent') selected @elseif(empty(old('purpose')) && $property->purpose == 'rent') selected @endif>Rent</option>
                            </select>
                        </div>
                    </div>
					...
					<div class="form-group form-float">
                        <div class="form-line">
                            ...
                            <select name="residential_property_type" class="form-control show-tick" onChange="updatePropertyType(this.value);">
                                <option value="">-- Please select --</option>
                                <option value="apartment_flat" @if(old('residential_property_type') == 'apartment_flat') selected @elseif(empty(old('residential_property_type')) && $property->residential_property_type == 'apartment_flat') selected @endif>Apartment/Flat</option>
                                <option value="house_villa" @if(old('residential_property_type') == 'house_villa') selected @elseif(empty(old('residential_property_type')) && $property->residential_property_type == 'house_villa') selected @endif>House/Villa</option>
							</select>
                        </div>
                    </div>
					
					<div class="form-group form-float" id="residential_apartment_div" @if(old('residential_property_type') == 'apartment_flat' || (old('residential_property_type') == '' && $property->residential_property_type == 'apartment_flat')) style="display:block;" @else style="display:none;"  @endif>
                        <div class="form-line">
							<label>Apartment/Flat Type</label>
                            <select name="residential_apartment_type" class="form-control show-tick">
                                <option value="">-- Please select --</option>
                                <option value="residential_apartment" @if(old('residential_apartment_type') == 'residential_apartment') selected @elseif(empty(old('residential_apartment_type')) && $property->residential_apartment_type == 'residential_apartment') selected @endif>Residential Apartment</option>
                                <option value="independent_floor" @if(old('residential_apartment_type') == 'independent_floor') selected @elseif(empty(old('residential_apartment_type')) && $property->residential_apartment_type == 'independent_floor') selected @endif>Independent Floor</option>
								<option value="studio_apartment" @if(old('residential_apartment_type') == 'studio_apartment') selected @elseif(empty(old('residential_apartment_type')) && $property->residential_apartment_type == 'studio_apartment') selected @endif>Studio Apartment</option>
								<option value="serviced_apartment" @if(old('residential_apartment_type') == 'serviced_apartment') selected @elseif(empty(old('residential_apartment_type')) && $property->residential_apartment_type == 'serviced_apartment') selected @endif>Serviced Apartment</option>
							</select>
                        </div>
                    </div>
					
					<div class="form-group form-float" id="residential_house_div" @if(old('residential_property_type') == 'house_villa' || (old('residential_property_type') == '' && $property->residential_property_type == 'house_villa')) style="display:block;" @else style="display:none;"  @endif>
                        <div class="form-line">
							<label>House/Villa Type</label>
                            <select name="residential_house_type" class="form-control show-tick">
                                <option value="">-- Please select --</option>
                                <option value="independent_house" @if(old('residential_house_type') == 'independent_house') selected @elseif(empty(old('residential_house_type')) && $property->residential_house_type == 'independent_house') selected @endif>Independent House/Villa</option>
                                <option value="farm_house" @if(old('residential_house_type') == 'farm_house') selected @elseif(empty(old('residential_house_type')) && $property->residential_house_type == 'farm_house') selected @endif>Farm House</option>
							</select>
                        </div>
                    </div>
...
@push('scripts')
    ...
    <script src="{{asset('public/backend/plugins/tinymce/tinymce.js')}}"></script>
    <script>
        $(function () {
            tinymce.init({
