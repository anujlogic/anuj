                        ...
                        <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{$key+1}}</td>
                                    <td>
                                        @if(file_exists('public/posts/'.$post->image))
                                            <img src="{{asset('public/posts/'.$post->image)}}" alt="{{$post->title}}" class="img-responsive img-rounded" style="height: 110px;width: 115px;">
                                        @endif
                                    </td>
                                    <td>
