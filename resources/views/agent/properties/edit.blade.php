                ...
                <div class="col s12 m9">
                    <div class="agent-content">
                        ...
                        <form action="{{route('agent.properties.update',$property->slug)}}" method="POST" enctype="multipart/form-data">
							...
							<div class="row" id="residential_apartment_div" @if(old('residential_property_type') == 'apartment_flat' || (old('residential_property_type') == '' && $property->residential_property_type == 'apartment_flat')) style="display:block;" @else style="display:none;"  @endif>
								<div class="input-field col s12" >
							...
							<div class="row" id="residential_house_div" @if(old('residential_property_type') == 'house_villa' || (old('residential_property_type') == '' && $property->residential_property_type == 'house_villa')) style="display:block;" @else style="display:none;"  @endif>
								<div class="input-field col s12" >
