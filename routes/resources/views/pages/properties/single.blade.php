                    ...
                    @else
                        <div class="single-image">
                            @if(file_exists('public/property/'.$property->image) && $property->image)
                                <img src="{{URL::assets('public/property/'.$property->image)}}" alt="{{$property->title}}" class="imgresponsive">
                            @endif
                        </div>
                    @endif
                    ...
                    <div class="card-no-box-shadow card">
                        ...
                        <div class="card-image">
                            @if(file_exists('public/property/'.$property->floor_plan) && $property->floor_plan)
                                <img src="{{URL::asset('public/property/'.$property->floor_plan)}}" alt="{{$property->title}}" class="imgresponsive">
                            @endif
                        </div>
                    </div>
                                    ...
                                    @if($property->user)
                                        <div class="card horizontal card-no-shadow">
                                            <div class="card-image p-l-10 agent-image">
                                                <img src="{{URL::assets('public/users/'.$property->user->image)}}" alt="{{ $property->user->username }}" class="imgresponsive">
                                            </div>
