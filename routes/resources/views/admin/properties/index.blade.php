...
@push('styles')
    ...
    <link rel="stylesheet" href="{{ asset('public/backend/plugins/jquery-datatable/skin/bootstrap/css/dataTables.bootstrap.css') }}">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if(file_exists('public/property/'.$property->image) && $property->image)
                                            <img src="{{asset('public/property/'.$property->image)}}" alt="{{$property->title}}" width="60" class="img-responsive img-rounded">
                                        @endif
                                    </td>
                                    <td>
...
@push('scripts')
    ...
    <script src="{{ asset('public/ackend/plugins/jquery-datatable/extensions/export/pdfmake.min.js') }}"></script>
