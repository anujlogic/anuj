...
Route::post('/search_autocomplete', 'AjaxController@searchAutocomplete');
Route::post('/state_cities', 'AjaxController@getStateCities');
Route::post('/location_address', 'AjaxController@getLocationAddress');
Route::post('/nearby_locations', 'AjaxController@getNearbyLocations');


Route::get('/test1', function(){	
	$key = 'AIzaSyDBeOQtelYZUNqy7eCGjdRU9L8G9ICA94k';
	$url = "https://maps.googleapis.com/maps/api/place/autocomplete/json?input=zirakpur&key=".$key;
	//$url ="https://maps.googleapis.com/maps/api/place/findplacefromtext/json?input=zirakpur&inputtype=textquery&fields=photos,formatted_address,name,rating,opening_hours,geometry&key=".$key;
	//$url = "https://maps.googleapis.com/maps/api/place/autocomplete/xml?input=Amoeba&types=establishment&location=37.76999,-122.44696&radius=500&key=AIzaSyDLr95G_KCgMt4YnPQq1m7DnYh0DoV5fDU";
